...
#define CMD_OPEN_NETSET_WORD_REQ  0x88
#define CMD_OPEN_NETSET_WORD_RSP  (CMD_OPEN_NETSET_WORD_REQ+1)  

#define CMD_CONFIG_NETSET_WORD_REQ  0x8A
#define CMD_CONFIG_NETSET_WORD_RSP  (CMD_CONFIG_NETSET_WORD_REQ+1)

#define CMD_NETSTATE_QUERY_WORD_REQ  0x8C
#define CMD_NETSTATE_QUERY_WORD_RSP  (CMD_NETSTATE_QUERY_WORD_REQ+1)

#define CMD_NETADDR_QUERY_WORD_REQ  0x8E
#define CMD_NETADDR_QUERY_WORD_RSP  (CMD_NETADDR_QUERY_WORD_REQ+1)

#define CMD_PING_WORD_REQ  0x90
#define CMD_PING_WORD_RSP  (CMD_PING_WORD_REQ+1)
